...
export default () => {
    ...
    const fetchData = async () => {
        const response = await fetch('https://ec2-3-137-200-96.us-east-2.compute.amazonaws.com:4000/teams'); 
        return await response.json();
    };

    const fetchUsers = async () => {
        const response = await fetch('https://ec2-3-137-200-96.us-east-2.compute.amazonaws.com:4000/totalUsers');
        return await response.json();
    }
